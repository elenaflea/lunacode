...
const graphisteWeb = document.querySelector(".graphisteWeb");
const graphisteGraphiste = document.querySelector(".graphisteGraphiste");
const graphisteDesign = document.querySelector(".graphisteDesign");
...
btnRu.addEventListener("click", () => {
    graphisteWeb.textContent = "Web";
    graphisteGraphiste.textContent = "графический";
    graphisteDesign.textContent = "дизайн";
   ...
   // linelink.textContent = "Посмотреть мои сертификаты здесь.";
    ...
    quinzeQuinze.textContent= "магазин";
    sieze.textContent= "художницы";
    ...
    headPriceUn.textContent = "Интернет-Сайт";
    startfromUn.textContent = "от";
    tarifparUn1.textContent = "Мобильная версия";
    tarifparUn2.textContent = "Интернет-магазин";
    tarifparUn3.textContent = "Хостинг включён";
    tarifparUn4.textContent = "Сопровождение";
    comUn.textContent = "ЗАКАЗАТЬ";

    headPriceDeux.textContent = "Флаер / Меню";
    startfromDeux.textContent = "от";
    tarifparDeux1.textContent = "1-2 варианта";
    tarifparDeux2.textContent = "Правки";
    tarifparDeux3.textContent = "Формат PDF";
    tarifparDeux4.textContent = "Сроки: 3 дня";
...
btnEn.addEventListener("click", () => { 
    graphisteWeb.textContent = "web";
    graphisteGraphiste.textContent = "graphic";
    graphisteDesign.textContent = "design";
   ...
   // linelink.textContent = "My certificates.";
    ...
    sieze.textContent= "Artist";
    seizeSeize.textContent= "shop";
    ...
    headPriceUn.textContent = "Your WEB Site";
    startfromUn.textContent = "start from";
    tarifparUn1.textContent = "Mobile version";
    tarifparUn2.textContent = "E-commerce integration";
    tarifparUn3.textContent = "Hosting included";
    tarifparUn4.textContent = "Help with domain name";
    comUn.textContent = "ORDER";

    headPriceDeux.textContent = "Flyer / Menu";
    startfromDeux.textContent = "start from";
    tarifparDeux1.textContent = "1-2 options minimum";
    tarifparDeux2.textContent = "Modifications";
    tarifparDeux3.textContent = "PDF files";
    tarifparDeux4.textContent = "Creation: 3 days";
...
btnFr.addEventListener("click", () => { 
    graphisteWeb.textContent = "Développeuse web";
    graphisteGraphiste.textContent = "";
    graphisteDesign.textContent = "Graphiste";
    moi.textContent = "MOI";
    applications.textContent = "APPLICATIONS";
  ...
  //  linelink.textContent = "Voir mes certificats ici.";
    ...
    sieze.textContent= "Artiste";
    seizeSeize.textContent= "boutique";
    ...
    headPriceUn.textContent = "Site WEB";
    startfromUn.textContent = "à partir de";
    tarifparUn1.textContent = "Adapté au mobile";
    tarifparUn2.textContent = "Integration E-commerce";
    tarifparUn3.textContent = "Hébergement web inclus";
    tarifparUn4.textContent = "Accompagnement";
    comUn.textContent = "COMMANDER";

    headPriceDeux.textContent = "Flyer / Menu";
    startfromDeux.textContent = "à partir de";
    tarifparDeux1.textContent = "1-2 Propositions";
    tarifparDeux2.textContent = "Modifications/Retouches";
    tarifparDeux3.textContent = "Format PDF";
    tarifparDeux4.textContent = "Création en 3 jours";
